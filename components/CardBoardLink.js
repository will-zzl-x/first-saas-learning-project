...
const CardBoardLink = ({ boardId }) => {
  const boardLink = `${
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://feedly.cyou"
  }/b/${boardId}`; // Construct the link to the board using the boardId
  // Example: const boardLink = `/dashboard/b/${boardId}`;
...
// This component can be used to generate a link to a specific board
// It can be used in the dashboard to link to a board's page
